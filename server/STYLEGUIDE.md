...
| `--accent-primary-dark` | `#6D28D9` | Headings, links, hover states |
| `--accent-light` | `#C4B5FD` | Borders, timeline gradient |
| `--accent-bg` | `#F5F3FF` | Light purple backgrounds |
...
| Headings (h1-h4) | Nunito | 800 |
| Bold text | DM Sans | 700 |
...
| Small element radius | `12px` / `16px` |
| Badge radius | `10px` / `12px` / `20px` |
...
```
Cards:       0 8px 32px rgba(0,0,0,0.08), inset 0 2px 4px rgba(255,255,255,0.8)
Light cards: 0 4px 8px rgba(0,0,0,0.04)
Clay card:   0 8px 32px rgba(0,0,0,0.08), 0 4px 12px rgba(0,0,0,0.04),
...
| Class | Purpose |
|-------|---------|
| `section-wrapper` | Standard section spacing (`margin-bottom: 40px`) |
| `clay-card` | Generic claymorphism card with multi-layer shadows |
| `blob`, `blob-1`, `blob-2`, `blob-3` | Animated background blobs (hidden in print) |

### Animated Blobs

LLM must include blob divs in the HTML body:
```html
